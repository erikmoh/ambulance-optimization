...
def visualize_third_experiment():
    ...
    strategies = pd.read_csv(file_path(sub_experiments[0])).columns
    ...
    for sub_experiment in sub_experiments:
        df = pd.read_csv(file_path(sub_experiment))
...
def visualize_fourth_experiment():
    ...
    index_plot(df, 'fourth_experiment/average_response_times_ratio_log', title='Average response times',
               xlabel='Number of day ambulances', ylabel='response time / (s)', log_scale=True)

    index_plot(df, 'fourth_experiment/average_response_times_ratio', title='Average response times',
               xlabel='Number of day ambulances', ylabel='response time / (s)', y_bottom=0, y_top=5000)
    ...
    multi_axis_plot(df, 'fourth_experiment/average_response_times_all', title='Average response times',
                    xlabel='No. day ambulances', ylabel='No. night ambulances', zlabel='response time / (s)', log_scale=True)
    print('done.')
