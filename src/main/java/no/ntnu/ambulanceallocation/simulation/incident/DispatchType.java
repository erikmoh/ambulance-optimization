...
public enum DispatchType {
  ...
  // Map for getting a dispatch type from the national name
  private static final Map<String, DispatchType> dispatchTypes = new HashMap<>();

  static {
    for (var DispatchType : DispatchType.values()) {
